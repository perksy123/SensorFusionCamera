...
void createMatrix1()
{
    ...
    m3_8u.setTo(cv::Scalar(255, 0, 0, 0));        
    ...
    string windowNameStudent = "Student Window (m2_8u)";
    cv::namedWindow(windowNameStudent, 2); // create window
    cv::imshow(windowNameStudent, m3_8u);
